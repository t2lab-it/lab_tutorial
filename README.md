...
なお，本稿の内容はあくまでも理工学系で理論・数値計算系の研究をしてきた執筆者（[荒木 亮@東京理科大学](https://ryo-araki.github.io/)）が自身の経験をもとにまとめたものですから，異なる分野や大学では文化が違うかもしれません．
...
- 参考：[数値計算屋のためのGit入門](https://speakerdeck.com/kaityo256/starting-git)
- TBA
