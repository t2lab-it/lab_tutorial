...
などがあり，どれも非常に有用です．
この文章も，将来的にはこれらと並ぶような情報を提供できれば，という目標のもと少しずつ書き足していく予定です．

なお，本稿の内容はあくまでも理工学系で理論・数値計算系の研究をしてきた執筆者（[荒木 亮@東京理科大学](https://ryo-araki.github.io/)）が自身の経験をもとにまとめたものなので，分野や大学が違うとまた異なる文化があると思います．
